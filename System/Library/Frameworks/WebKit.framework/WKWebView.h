...
@class WKBrowsingContextHandle, NSURL, NSArray, NSString, NSData, _WKSessionState, _WKWebViewPrintFormatter, WKWebViewContentProviderRegistry, WKWebViewConfiguration, WKBackForwardList, UIScrollView;
