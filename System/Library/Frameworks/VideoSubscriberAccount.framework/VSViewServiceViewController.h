...
@class VSAccountStore, VSRemoteNotifier, VSPreferences, BKSApplicationStateMonitor, NSOperationQueue, VSViewServiceRequest, NSUUID, VSIdentityProviderController, NSString;
