...
@class AVAsset, NSObject, AVPlayerItem, MPQueueFeeder, MPAVController, NSArray, MPAlternateTracks, NSError, NSString, MPMediaItem, MPModelSong, MPModelObject, MPStoreDownload, NSNumber, NSDictionary, AVPlayerItemAccessLog, NSURL, MPAlternateTextTrack;
