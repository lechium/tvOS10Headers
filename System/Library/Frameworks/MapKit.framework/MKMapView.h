...
@class MKMapViewInternal, UIView, MKMapAnnotationManager, MKAnnotationContainerView, MKAttributionLabel, UIImageView, NSTimer, MKDebugLocationConsole, _MKEnvironmentLabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIGestureRecognizer, MKMapGestureController, MKOverlayContainerView, MKBasicMapView, VKMapView, VKLabelMarker, MKScaleView, MKCompassView, MKUserLocation, VKRouteContext, VKNavContext, MKMapCamera, UITextView, UIPanGestureRecognizer, UILayoutGuide, NSLayoutConstraint, UIVisualEffectView, UISwipeGestureRecognizer, _MKMapInteractionControlsView, NSArray, _MKMapInteractionControlAction, _MKAnnotationSelectionEngine, _MKZoomSliderView, _MKRightSideOfTrackpadTouchGestureRecognizer, _MKGameControllerObserver, CLLocation, MKAnnotationView, NSString, NSDictionary, GEOResourceManifestConfiguration, GEOMapRegion, UIPopoverController, UIPinchGestureRecognizer, UIRotationGestureRecognizer;
