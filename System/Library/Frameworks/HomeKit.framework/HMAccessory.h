...
@class NSUUID, NSString, HMHome, HMRoom, NSArray, HMAccessoryCategory, HMApplicationData, NSNumber, HMFMessageDispatcher, HMThreadSafeMutableArrayCollection, NSObject, HMDelegateCaller;
