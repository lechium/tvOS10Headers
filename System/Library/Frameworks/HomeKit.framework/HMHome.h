...
@class NSUUID, CLLocation, NSString, HMPendingRequests, HMUser, HMApplicationData, NSDate, HMDelegateCaller, NSObject, HMHomeManager, HMFMessageDispatcher, HMSetupViewController, HMThreadSafeMutableArrayCollection, HMRoom, NSArray;
