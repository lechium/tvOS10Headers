...
+(SCD_Struct_CM25)gyroCalibrationDatabaseGetBiasFit;
...
+(SCD_Struct_CM25)gyroCalibrationDatabaseGetBiasFitAndEstimate:(SCD_Struct_CM3*)arg1 atTemperature:(float)arg2 ;
+(BOOL)hasRunMiniCal;
...
-(void)startDeviceMotionLiteUpdatesForDeviceID:(id)arg1 usingConfiguration:(SCD_Struct_CM26)arg2 toQueue:(id)arg3 withFusedHandler:(/*^block*/id)arg4 debugHandler:(/*^block*/id)arg5 ;
