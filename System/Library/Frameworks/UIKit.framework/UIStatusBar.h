...
+(void)getData:(SCD_Struct_UI72*)arg1 forRequestedData:(const SCD_Struct_UI72*)arg2 withOverrides:(const SCD_Struct_UI75*)arg3 ;
...
-(void)forceUpdateToData:(const SCD_Struct_UI72*)arg1 animated:(BOOL)arg2 ;
