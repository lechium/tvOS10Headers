...
-(CGSize)size;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI14)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI17)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI17)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI14)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI17)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI14)arg1 inRect:(CGRect)arg2 ;
