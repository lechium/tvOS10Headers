...
@class _UICascadingTextStorage, UIImage, UIView, UITextInputTraits, _UIFullFontSize, UIButton, UITextFieldBorderView, UITextFieldBackgroundView, _UIFloatingContentView, UIVisualEffectView, _UIDetachedFieldEditorBackgroundView, UITextFieldLabel, UIImageView, UILabel, NSAttributedString, UITextInteractionAssistant, UITapGestureRecognizer, UISystemInputViewController, UITextFieldAtomBackgroundView, NSUUID, NSString, CUICatalog, CUIStyleEffectConfiguration, NSLayoutConstraint, _UIBaselineLayoutStrut, UIColor, UIFont, NSDictionary, NSIndexSet, UIInputContextHistory, UITextRange, UITextPosition;
