...
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI36)arg1 renderingContext:(id)arg2 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI36)arg1 renderingContext:(id)arg2 skipLayoutSegments:(BOOL)arg3 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI36)arg1 renderingContext:(id)arg2 ;
