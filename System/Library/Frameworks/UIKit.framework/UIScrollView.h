...
@class UIImageView, _UIStaticScrollBar, UIView, UIScrollViewPinchGestureRecognizer, UIScrollViewDirectionalPressGestureRecognizer, UISwipeGestureRecognizer, UIRefreshControl, NSISVariable, NSArray, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIGestureRecognizer, NSString;
