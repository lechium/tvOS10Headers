...
@property (nonatomic,retain) _TVSDecoratorRequest * decoratorRequestToken;              //@synthesize decoratorRequestToken=_decoratorRequestToken - In the implementation block
...
@property (nonatomic,retain) TVSImageDecorator * decorator;                             //@synthesize decorator=_decorator - In the implementation block
@property (nonatomic,copy) id completionHandler;                                        //@synthesize completionHandler=_completionHandler - In the implementation block
@property (nonatomic,copy) id writeCompletionHandler;                                   //@synthesize writeCompletionHandler=_writeCompletionHandler - In the implementation block
...
-(id)imageLoader;
-(TVSImageDecorator *)decorator;
-(void)setDecorator:(TVSImageDecorator *)arg1 ;
-(BOOL)cacheOnLoad;
...
-(void)setDecoratorRequestToken:(_TVSDecoratorRequest *)arg1 ;
...
-(id)requestToken;
-(_TVSDecoratorRequest *)decoratorRequestToken;
