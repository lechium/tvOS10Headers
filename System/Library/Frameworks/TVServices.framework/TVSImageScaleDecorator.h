...
@property (assign,nonatomic) TVSCornerRadii cornerRadii;              //@synthesize cornerRadii=_cornerRadii - In the implementation block
...
+(id)_decoratorIdentifierWithScaleToSize:(CGSize)arg1 mode:(long long)arg2 cornerRadii:(TVSCornerRadii)arg3 ;
+(id)_decoratorIdentifierWithScaleToSize:(CGSize)arg1 mode:(long long)arg2 ;
-(void)setMode:(long long)arg1 ;
-(long long)mode;
-(void)setCornerRadii:(TVSCornerRadii)arg1 ;
...
-(id)_scaleImage:(id)arg1 toSize:(CGSize)arg2 forceImageSize:(BOOL)arg3 drawInScaledContext:(BOOL)arg4 ;
