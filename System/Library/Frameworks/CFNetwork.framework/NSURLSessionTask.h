...
@class NSURLRequest, NSURL, NSURLResponse, NSError, NSURLSession, NSString, NSDictionary, NSArray, NSURLSessionTaskHTTPAuthenticator, NSURLSessionTaskDependencyTree, NSURLSessionTaskDependency;
