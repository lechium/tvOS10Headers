...
@class AFUIDelayedActionCommandCache, SiriUIConfiguration, NSString, NSObject, AFUISiriSession, AFUISiriRemoteViewController, SiriUIAudioRoutePickerController, UIStatusBar, AFUIRequestOptions, NSNumber;
