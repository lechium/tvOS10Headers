...
@property (assign,nonatomic) SCD_Struct_GE91* road;                                                  //@synthesize road=_road - In the implementation block
...
-(void)setRoad:(SCD_Struct_GE91*)arg1 ;
