...
@property (nonatomic,readonly) SCD_Struct_GE98* vertices;              //@synthesize vertices=_vertices - In the implementation block
...
-(void)setVertices:(SCD_Struct_GE98*)arg1 count:(long long)arg2 ;
@end
