...
@interface GEORequester : GEOPBSessionRequester {
	...
	BOOL _canceled;
	SCD_Struct_GE103 _conditionalConnectionProperties;
...
@property (assign,nonatomic) SCD_Struct_GE103 conditionalConnectionProperties;              //@synthesize conditionalConnectionProperties=_conditionalConnectionProperties - In the implementation block
...
-(void)setConditionalConnectionProperties:(SCD_Struct_GE103)arg1 ;
...
-(SCD_Struct_GE103)conditionalConnectionProperties;
-(BOOL)disableReplay;
