...
@property (nonatomic,readonly) SCD_Struct_GE91* roadFeature;                //@synthesize roadFeature=_roadFeature - In the implementation block
-(void)dealloc;
-(NSString *)roadName;
-(double)roadWidth;
-(double)distanceFromJunction;
-(id)initWithCoordinateOnRoad:(SCD_Struct_GE26)arg1 courseOnRoad:(double)arg2 ;
-(void)setRoadFeature:(SCD_Struct_GE91*)arg1 ;
-(SCD_Struct_GE91*)roadFeature;
