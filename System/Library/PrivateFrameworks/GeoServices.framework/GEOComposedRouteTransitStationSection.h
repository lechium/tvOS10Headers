...
@interface GEOComposedRouteTransitStationSection : GEOComposedRouteSection <GEOComposedRouteTransitSection> {
	...
	SCD_Struct_GE84 _fromNodeID;
	SCD_Struct_GE84 _toNodeID;
	int _toNodeSignificance;
	SCD_Struct_GE49 _originalBounds;

}

@property (nonatomic,readonly) SCD_Struct_GE84 fromNodeID;              //@synthesize fromNodeID=_fromNodeID - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE84 toNodeID;                //@synthesize toNodeID=_toNodeID - In the implementation block
