...
@class NSHashTable, NSData, NSArray, NSString, NSDate, GEORoute, GEORouteSet, GEOMapRegion, NSMutableArray, GEOZilchDecoder, GEOTransitDecoderData, GEOTransitSuggestedRoute, GEOComposedWaypoint, GEORouteAttributes, GEOStyleAttributes;
...
@interface GEOComposedRoute : NSObject <GEOMapAccessRestrictions> {
	...
	SCD_Struct_GE87* _currentManeuverDisplayEndPoints;
...
-(SCD_Struct_GE87)maneuverDisplayEndpointsAtIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_GE91*)roadFeatureAtPointIndex:(unsigned)arg1 ;
