...
@class BWFigVideoCaptureDevice, BWFigVideoCaptureStream, NSArray, BWNodeOutput, NSDictionary, BWDeferredMetadataCache, NSMutableDictionary, BWDetectedFacesRingBuffer, NSObject, NSString;
