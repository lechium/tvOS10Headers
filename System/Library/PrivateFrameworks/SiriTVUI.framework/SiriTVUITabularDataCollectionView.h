...
#import <SiriTVUI/SiriTVUITemplateTabularDataTextCellDelegate.h>

@class NSString;

@interface SiriTVUITabularDataCollectionView : UICollectionView <SiriTVUITemplateTabularDataTextCellDelegate> {
...
-(BOOL)shouldAllowFocusForCell:(id)arg1 ;
