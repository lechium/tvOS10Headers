...
#import <libobjc.A.dylib/TVSPlaybackDelegate.h>

@class TVSStateMachine, NSArray, TVLLegacyJSContext, TVSInterstitialCollection, NSOperationQueue, NSSet, NSString;

@interface TVLJSPlayer : NSObject <TVSPlaybackDelegate> {
	...
	TVSInterstitialCollection* _interstitialCollection;
...
@property (retain) TVSInterstitialCollection * interstitialCollection;              //@synthesize interstitialCollection=_interstitialCollection - In the implementation block
...
-(void)setInterstitialCollection:(TVSInterstitialCollection *)arg1 ;
...
-(TVSInterstitialCollection *)interstitialCollection;
