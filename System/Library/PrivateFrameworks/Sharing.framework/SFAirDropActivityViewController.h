...
@class NSString, UILabel, UIButton, SFAirDropIconView, NSLayoutConstraint, SFAirDropActiveIconView, UICollectionView, UICollectionViewFlowLayout, SFPersonCollectionViewCell, NSMutableDictionary, SFAirDropBrowser, SFWirelessSettingsController, NSMutableSet, NSOperationQueue, NSMutableArray, UIVisualEffectView, UIFocusContainerGuide, NSObject;
