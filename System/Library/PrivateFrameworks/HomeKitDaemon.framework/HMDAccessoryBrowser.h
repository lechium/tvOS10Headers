...
@class NSObject, NSUUID, HMFMessageDispatcher, NSMutableSet, HMDHomeManager, NSMapTable, NSMutableArray, HAPAccessoryServerBrowserIP, HAPAccessoryServerBrowserBTLE, HAPAccessoryServerBrowserRelay, NSHashTable, NSString;
