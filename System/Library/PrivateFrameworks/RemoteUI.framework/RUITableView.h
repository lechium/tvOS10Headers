...
@interface RUITableView : RUIElement <UITableViewDataSource, UITableViewDelegate, RUITableViewRowDelegate, RUITableViewSectionDelegate, RUITopLevelPageElement> {
