...
@class UIView, UITextField, RUIElement, NSString, TVDigitEntryViewController, RUIObjectModel, RUIPage, PSPasscodeField, UIColor, RUIHeaderElement, RUIHTMLHeaderElement;
