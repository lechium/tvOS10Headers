...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT21 _scissorRect;
	SCD_Struct_MT23 _viewport;
...
@property (nonatomic,readonly) SCD_Struct_MT23 viewport;                                               //@synthesize viewport=_viewport - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_MT21 scissorRect;                                            //@synthesize scissorRect=_scissorRect - In the implementation block
...
-(void)setViewport:(SCD_Struct_MT23)arg1 ;
-(void)endEncoding;
...
-(void)setScissorRect:(SCD_Struct_MT21)arg1 ;
