...
+ (id)appCardViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0000000100007e70
...
- (void).cxx_destruct;	// IMP=0x000000010000a180
- (struct UIEdgeInsets)selectionMarginsForSize:(struct CGSize)arg1;	// IMP=0x0000000100009f60
- (void)layoutSubviews;	// IMP=0x0000000100009aa0
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100008e90
- (unsigned long long)_primaryStateForState:(unsigned long long)arg1;	// IMP=0x0000000100008e6c
@property(nonatomic, getter=isSelected) _Bool selected;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000087e8
