...
@interface TVASBuyButtonInfo : NSObject <NSCopying>
{
    ...
    _Bool _updateableOverride;	// 10 = 0xa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000ea4c
- (id)copyAfterAppUpdate;	// IMP=0x000000010000ea10
...
- (id)initWithViewElement:(id)arg1 pricingText:(id)arg2 actionTitle:(id)arg3;	// IMP=0x000000010000e1e4
