...
- (void).cxx_destruct;	// IMP=0x000000010002d080
- (void)_updateWithCurrentStyle;	// IMP=0x000000010002cc90
- (void)_updateImageViews;	// IMP=0x000000010002c980
@property(readonly, nonatomic) struct CGSize imageSize;
- (void)layoutSubviews;	// IMP=0x000000010002c448
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000010002c288
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002c220
