...
+ (id)insertUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x0000000100025bf0
+ (id)deleteUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x0000000100025b68
...
- (void).cxx_destruct;	// IMP=0x0000000100025cb8
- (id)initWithType:(long long)arg1 item:(id)arg2 fromIndexPath:(id)arg3 toIndexPath:(id)arg4;	// IMP=0x0000000100025a44
