...
- (void).cxx_destruct;	// IMP=0x0000000100058ff8
- (id)fetchImage;	// IMP=0x0000000100058d14
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0000000100058b50
- (id)init;	// IMP=0x0000000100058b38
