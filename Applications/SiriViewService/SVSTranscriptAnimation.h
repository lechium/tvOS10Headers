...
+ (id)cancellationAnimationForTranscriptItem:(id)arg1;	// IMP=0x0000000100024054
+ (id)confirmationAnimationForTranscriptItem:(id)arg1;	// IMP=0x0000000100023fd4
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2 replacedView:(id)arg3;	// IMP=0x0000000100023f44
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2;	// IMP=0x0000000100023ed4
...
- (void).cxx_destruct;	// IMP=0x000000010002490c
- (id)_animationTypeString;	// IMP=0x00000001000246b8
- (id)description;	// IMP=0x00000001000245e4
- (double)pinMinimumDuration;	// IMP=0x00000001000245a8
- (double)animationDelay;	// IMP=0x0000000100024534
- (id)_snippetViewControllerIfExists;	// IMP=0x0000000100024498
- (id)_aceViewControllerIfExists;	// IMP=0x00000001000243fc
- (id)initWithTranscriptItem:(id)arg1 replacedView:(id)arg2 updateType:(long long)arg3;	// IMP=0x00000001000240d4
