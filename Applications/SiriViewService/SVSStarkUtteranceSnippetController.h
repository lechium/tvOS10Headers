...
- (void).cxx_destruct;	// IMP=0x000000010005465c
- (void)viewDidLoad;	// IMP=0x00000001000545b0
- (void)loadView;	// IMP=0x0000000100054598
- (id)initWithAceObject:(id)arg1;	// IMP=0x00000001000543cc
