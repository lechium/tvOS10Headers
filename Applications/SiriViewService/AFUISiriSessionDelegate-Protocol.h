...
@class AFSpeechInterpretation, AFUIRequestOptions, AceObject<SAAceCommand>, INImage, NSArray, NSError, NSString, NSURL, SAGuidanceGuideUpdate, SAPhonePlayVoiceMail, SASSpeechPartialResult, SASSpeechRecognized, SASettingSetUIGuidedAccess, SASmsPlayAudio, SAUIAddContentToView, SAUIAddViews, SAUIAppPunchOut, SAUIChangePrimaryUtterance, SAUIClearScreen, SAUICloseAssistant, SAUIHideSiriOverlay, SAUIListenForPronunciation, SAUIOpenLink, SAUIRepeatIt, SAUISayIt, SAUISetSuggestedUtterances, SAUIShowHelp, SAUIUpdateViews;
