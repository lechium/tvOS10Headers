...
@class AFConversation, AFDialogPhase, AceObject, NSArray, NSIndexPath, NSSet, NSString, NSURL, NSUUID, SAUIListItem;
...
- (void)getLastAppUpdateTimeForSiriPresentation:(id <SiriUIPresentation>)arg1 complete:(void (^)(NSDate *))arg2;
