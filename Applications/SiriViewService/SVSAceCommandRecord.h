...
- (void).cxx_destruct;	// IMP=0x00000001000311c0
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00000001000310c4
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0000000100031028
- (void)incrementNumberOfStartedActions;	// IMP=0x0000000100030ff0
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100030cb0
