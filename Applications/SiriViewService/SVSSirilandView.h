...
+ (id)sirilandView;	// IMP=0x000000010002e3f8
...
- (void).cxx_destruct;	// IMP=0x000000010002eb54
- (void)statusBarFrameDidChange;	// IMP=0x000000010002e9cc
- (void)layoutSubviews;	// IMP=0x000000010002e6bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002e420
