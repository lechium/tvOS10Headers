...
+ (id)font;	// IMP=0x0000000100167f80
+ (double)height;	// IMP=0x0000000100167ed4
...
- (void).cxx_destruct;	// IMP=0x0000000100168e18
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100168c14
- (void)layoutSubviews;	// IMP=0x000000010016878c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001001686bc
@property(retain, nonatomic) NSString *backdropGroupName;
- (void)_updateBlurEffects;	// IMP=0x00000001001682d8
- (void)prepareForReuse;	// IMP=0x0000000100168244
- (void)_configureSubviews;	// IMP=0x000000010016801c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100167fa0
