...
- (void).cxx_destruct;	// IMP=0x000000010008b464
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x000000010008b2ec
- (void)showEditTitleUI;	// IMP=0x000000010008b1a4
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000010008b0b0
