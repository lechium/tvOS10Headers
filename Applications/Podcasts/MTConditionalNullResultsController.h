...
- (void).cxx_destruct;	// IMP=0x0000000100116830
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x00000001001166e0
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100116524
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100116520
- (id)_extraObjects;	// IMP=0x00000001001163f4
- (id)allObjects;	// IMP=0x0000000100116350
- (void)_initializeFrc;	// IMP=0x00000001001162a0
