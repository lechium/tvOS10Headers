...
@interface MTSetPlaybackQueueRequest : NSObject
{
    ...
    _Bool _startPlayback;	// 9 = 0x9
    _Bool _suppressMetrics;	// 10 = 0xa
    MTPlayerManifest *_manifest;	// 16 = 0x10
    MTPlaybackContext *_context;	// 24 = 0x18
    CDUnknownBlockType _completion;	// 32 = 0x20
}

+ (id)requestWithContext:(id)arg1;	// IMP=0x000000010012eeb8
...
- (void).cxx_destruct;	// IMP=0x000000010012f1c4
- (void)finish:(_Bool)arg1;	// IMP=0x000000010012f03c
- (_Bool)validate;	// IMP=0x000000010012ef4c
