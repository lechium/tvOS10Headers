...
- (void).cxx_destruct;	// IMP=0x000000010007c724
- (void)layoutSubviews;	// IMP=0x000000010007c238
- (void)_updateGradientColors;	// IMP=0x000000010007c0c4
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x000000010007c024
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x000000010007bc40
- (id)init;	// IMP=0x000000010007bc2c
