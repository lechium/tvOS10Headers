...
- (void).cxx_destruct;	// IMP=0x00000001000ee154
- (void)addCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ee02c
- (id)initWithProperties:(id)arg1;	// IMP=0x00000001000edc94
- (id)init;	// IMP=0x00000001000edc84
