...
@class NSArray, NSDate, NSObject<TVSMediaItem>, NSString, TVSAudioOption, TVSChapter, TVSChapterCollection, TVSDateRange, TVSInterstitial, TVSPlaybackState, TVSPlaylist, TVSSubtitleOption, TVSTimeRange;
...
- (void)setSelectedSubtitleOption:(TVSSubtitleOption *)arg1 setGlobalPreference:(_Bool)arg2;
