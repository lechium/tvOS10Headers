...
- (void).cxx_destruct;	// IMP=0x00000001000c8784
- (id)metricsAdditionalData;	// IMP=0x00000001000c8574
- (id)metricsContentIdentifier;	// IMP=0x00000001000c8558
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000001000c8524
- (id)activitySpotlightIdentifier;	// IMP=0x00000001000c851c
- (id)activity;	// IMP=0x00000001000c84c0
- (id)init;	// IMP=0x00000001000c8414
