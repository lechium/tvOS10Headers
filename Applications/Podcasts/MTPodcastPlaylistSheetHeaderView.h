...
- (void).cxx_destruct;	// IMP=0x00000001000b1068
- (void)buttonTapped:(id)arg1;	// IMP=0x00000001000b0f6c
- (void)layoutSubviews;	// IMP=0x00000001000b0c38
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b090c
