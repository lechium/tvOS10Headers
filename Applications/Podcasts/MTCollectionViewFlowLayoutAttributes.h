...
- (id)description;	// IMP=0x0000000100043824
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100043770
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000435b8
- (unsigned long long)hash;	// IMP=0x0000000100043524
