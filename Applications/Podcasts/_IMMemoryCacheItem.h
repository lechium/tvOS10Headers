...
+ (id)cacheItemWithItem:(id)arg1 key:(id)arg2 cost:(unsigned long long)arg3;	// IMP=0x000000010017e59c
...
- (id)description;	// IMP=0x000000010017e6f0
- (void)dealloc;	// IMP=0x000000010017e688
