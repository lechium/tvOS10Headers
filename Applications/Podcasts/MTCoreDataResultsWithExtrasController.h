...
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010011e168
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010011dfa8
- (_Bool)_hasResults;	// IMP=0x000000010011df20
- (id)_extraObjects;	// IMP=0x000000010011de58
- (id)allObjects;	// IMP=0x000000010011dd90
- (void)_initializeFrc;	// IMP=0x000000010011dce4
