...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x000000010008c748
...
- (void).cxx_destruct;	// IMP=0x000000010008cf20
- (id)description;	// IMP=0x000000010008cc9c
- (_Bool)isEmpty;	// IMP=0x000000010008cacc
- (id)children;	// IMP=0x000000010008cabc
- (void)addChild:(id)arg1;	// IMP=0x000000010008ca38
