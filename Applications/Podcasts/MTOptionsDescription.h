...
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3;	// IMP=0x00000001000e780c
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3 footerTextCallback:(CDUnknownBlockType)arg4 headerTextCallback:(CDUnknownBlockType)arg5;	// IMP=0x00000001000e76d8
...
- (unsigned long long)valueForIndex:(unsigned long long)arg1;	// IMP=0x00000001000e78f8
- (unsigned long long)indexForValue:(unsigned long long)arg1;	// IMP=0x00000001000e7890
