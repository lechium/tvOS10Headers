...
+ (id)UPPDomainVersion;	// IMP=0x0000000100071c50
+ (void)setUPPDomainVersion:(id)arg1;	// IMP=0x0000000100071bac
...
- (void).cxx_destruct;	// IMP=0x0000000100071d40
- (id)lastSyncedDomainVersion;	// IMP=0x0000000100071cb4
