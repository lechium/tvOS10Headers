...
- (void).cxx_destruct;	// IMP=0x0000000100041fc8
- (_Bool)allowsFooterViewsToFloat;	// IMP=0x0000000100041ed4
- (id)preferredFocusedView;	// IMP=0x0000000100041e34
- (void)decodeRestorableStateWithCoder:(id)arg1;	// IMP=0x0000000100041e00
- (void)encodeRestorableStateWithCoder:(id)arg1;	// IMP=0x0000000100041dcc
- (void)setContentSize:(struct CGSize)arg1;	// IMP=0x0000000100041d98
- (void)setContentInset:(struct UIEdgeInsets)arg1;	// IMP=0x0000000100041d64
- (void)setContentOffset:(struct CGPoint)arg1;	// IMP=0x0000000100041d30
- (struct UIEdgeInsets)insetsFromRefreshControl;	// IMP=0x0000000100041c54
- (void)setRefreshControl:(id)arg1;	// IMP=0x0000000100041bc4
- (void)enablePullToRefresh;	// IMP=0x0000000100041b20
- (void)disablePullToRefresh;	// IMP=0x0000000100041ae8
- (void)updateRefreshControlEnabledState;	// IMP=0x0000000100041a54
- (void)setEditing:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000419dc
- (void)setPinsHeaderToTop:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010004185c
- (void)setTableFooterView:(id)arg1;	// IMP=0x0000000100041484
- (void)layoutSubviews;	// IMP=0x0000000100040f80
