...
- (void).cxx_destruct;	// IMP=0x00000001001bb5a4
- (id)description;	// IMP=0x00000001001bb258
@property(readonly, nonatomic) UIImage *artwork;
- (unsigned long long)hash;	// IMP=0x00000001001bad68
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001baa98
