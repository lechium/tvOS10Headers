...
+ (id)insertNewTheme:(id)arg1 forUuid:(id)arg2 inMOC:(id)arg3;	// IMP=0x000000010002f780
+ (_Bool)createOrUpdateTheme:(id)arg1 forUuid:(id)arg2 inMOC:(id)arg3;	// IMP=0x000000010002f660
- (void)populateWithColorTheme:(id)arg1;	// IMP=0x000000010002f930
- (id)convertToColorTheme;	// IMP=0x000000010002f824
