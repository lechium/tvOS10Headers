...
+ (id)deleteAllContentInCtx:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000c5dd4
+ (id)createOrUpdateUPPMetadataFromUPPRecord:(id)arg1 inCtx:(id)arg2;	// IMP=0x00000001000c5c3c
+ (id)createOrUpdateUPPMetadataFromUPPMediaItem:(id)arg1 inCtx:(id)arg2;	// IMP=0x00000001000c5b7c
