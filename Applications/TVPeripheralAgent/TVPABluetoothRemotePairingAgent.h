...
- (void).cxx_destruct;	// IMP=0x0000000100003c94
- (void)_peripheralStateDidChangeNotification:(id)arg1;	// IMP=0x0000000100003a40
- (void)_handleRemoteDidPair;	// IMP=0x0000000100003704
- (void)_handlePairingTimeout;	// IMP=0x00000001000035d4
- (void)unpairAllRemotes;	// IMP=0x0000000100003254
- (void)stopProximityPairing;	// IMP=0x0000000100003130
- (void)startProximityPairing;	// IMP=0x0000000100002d4c
- (void)dealloc;	// IMP=0x0000000100002c48
