...
+ (id)_keyValueDictionaryForURL:(id)arg1;	// IMP=0x00000001000974d8
+ (id)configWithPrefsURL:(id)arg1;	// IMP=0x0000000100096da4
+ (id)configWithAppSettingsURL:(id)arg1;	// IMP=0x0000000100096c6c
+ (id)configWithSettingsURL:(id)arg1;	// IMP=0x0000000100096bb8
...
- (void).cxx_destruct;	// IMP=0x00000001000977d8
