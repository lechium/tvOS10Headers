...
+ (_Bool)automaticallyNotifiesObserversOfLazyActiveAccount;	// IMP=0x000000010000a210
@property(retain, nonatomic) TVSiCloudAccountManager *accountManager; // @synthesize accountManager=_accountManager;
- (void).cxx_destruct;	// IMP=0x000000010000a498
@property(retain, nonatomic) ACAccount *lazyActiveAccount;
- (id)initWithAccountManager:(id)arg1;	// IMP=0x000000010000a184
