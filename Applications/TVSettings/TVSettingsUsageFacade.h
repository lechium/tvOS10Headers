...
- (void).cxx_destruct;	// IMP=0x0000000100066a30
- (void)_fetchAppUsageInfo;	// IMP=0x00000001000664d4
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x00000001000662f8
- (void)dealloc;	// IMP=0x0000000100066218
