...
- (void)pairWithPasscode:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100061d44
- (void)unpairWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100061cbc
- (unsigned long long)hash;	// IMP=0x0000000100061c48
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000619ec
- (id)initWithEndpoint:(id)arg1;	// IMP=0x0000000100061924
- (id)initWithDeviceRef:(void *)arg1;	// IMP=0x0000000100061878
