...
- (void).cxx_destruct;	// IMP=0x0000000100012004
- (void)_launchAppForSettingItem:(id)arg1;	// IMP=0x0000000100011e1c
- (void)_didSelectSettingItem:(id)arg1;	// IMP=0x0000000100011d6c
- (id)_photoCollectionGroups;	// IMP=0x0000000100011cb8
- (id)_localizedTitleForPhotoCollectionGroup:(id)arg1;	// IMP=0x0000000100011ca8
- (void)controller:(id)arg1 didSelectAsset:(id)arg2 inCollection:(id)arg3;	// IMP=0x0000000100011ba4
- (id)loadSettingGroups;	// IMP=0x0000000100011678
- (id)title;	// IMP=0x0000000100011608
