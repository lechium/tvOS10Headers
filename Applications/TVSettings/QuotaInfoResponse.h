...
- (void).cxx_destruct;	// IMP=0x000000010009b7c4
- (_Bool)hasPurchasedMoreStorage;	// IMP=0x000000010009b750
- (id)storageFooter:(_Bool)arg1;	// IMP=0x000000010009b748
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x000000010009afc0
