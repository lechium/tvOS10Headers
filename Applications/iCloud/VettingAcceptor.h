...
- (void)dealloc;	// IMP=0x00000001000199d0
- (void)completeVettingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100019278
- (void)retrievingDialogCancelled;	// IMP=0x0000000100019220
- (_Bool)retrievingDialogShouldDisplay;	// IMP=0x0000000100019218
- (id)initWithCloudKitURL:(id)arg1;	// IMP=0x00000001000190fc
