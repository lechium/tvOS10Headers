...
- (void).cxx_destruct;	// IMP=0x000000010005c2cc
- (struct CGSize)_getAttributedStringSizeForText:(id)arg1 font:(id)arg2;	// IMP=0x000000010005c188
- (void)layoutSubviews;	// IMP=0x000000010005bfa0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005bd04
