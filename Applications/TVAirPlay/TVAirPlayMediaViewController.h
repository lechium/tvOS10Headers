...
+ (id)_remoteViewControllerInterface;	// IMP=0x0000000100017078
+ (id)_exportedInterface;	// IMP=0x0000000100016f5c
...
- (void).cxx_destruct;	// IMP=0x000000010001784c
- (void)_transitionFromViewController:(id)arg1 toViewController:(id)arg2;	// IMP=0x0000000100017094
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100016c34
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x0000000100016ae8
- (void)dismiss;	// IMP=0x00000001000169dc
- (id)preferredFocusEnvironments;	// IMP=0x00000001000160d4
