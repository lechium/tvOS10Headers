...
- (void).cxx_destruct;	// IMP=0x00000001000137d4
- (void)_updatePlaybackActive;	// IMP=0x00000001000135f4
- (void)_updateCloudConnectivityState;	// IMP=0x0000000100013420
- (void)_reenableAirPlaySpeakerIfNecessary;	// IMP=0x000000010001303c
- (void)_disableAirPlaySpeakerIfNecessary;	// IMP=0x0000000100012cbc
- (void)applicationWillTerminate:(id)arg1;	// IMP=0x0000000100012b20
- (void)dealloc;	// IMP=0x0000000100012aa4
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x000000010001278c
