...
- (void)report:(id)arg1;	// IMP=0x000000010001b384
- (void)share:(id)arg1;	// IMP=0x000000010001b358
- (void)challenge:(id)arg1;	// IMP=0x000000010001b178
- (void)configureForScore;	// IMP=0x000000010001ac20
- (id)preferredFocusEnvironments;	// IMP=0x000000010001aba0
- (void)viewDidLoad;	// IMP=0x000000010001ab34
- (void)dealloc;	// IMP=0x000000010001aac0
- (id)initWithScore:(id)arg1 leaderboard:(id)arg2;	// IMP=0x000000010001a9e0
