...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100021b18
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x0000000100021a38
- (_Bool)isShowMoreIndexPath:(id)arg1;	// IMP=0x00000001000219b4
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000010002196c
- (void)loadDataWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100021690
- (void)setupCollectionView:(id)arg1;	// IMP=0x0000000100021548
...
- (id)initWithGameRecord:(id)arg1;	// IMP=0x0000000100021384
