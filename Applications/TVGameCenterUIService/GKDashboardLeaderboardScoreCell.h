...
+ (id)highRankNib;	// IMP=0x0000000100025174
+ (id)lowRankNib;	// IMP=0x0000000100025148
+ (struct CGSize)defaultSize;	// IMP=0x0000000100025134
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000255d0
@property(nonatomic) _Bool linesVisible; // @dynamic linesVisible;
- (void)setupForScore:(id)arg1;	// IMP=0x0000000100025418
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)dealloc;	// IMP=0x0000000100025318
- (void)awakeFromNib;	// IMP=0x00000001000251a0
