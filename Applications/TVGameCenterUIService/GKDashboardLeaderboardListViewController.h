...
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x000000010000dfb4
- (void)viewDidLoad;	// IMP=0x000000010000de20
- (void)dealloc;	// IMP=0x000000010000ddc4
- (id)initWithGameRecord:(id)arg1 leaderboardSet:(id)arg2;	// IMP=0x000000010000dcbc
