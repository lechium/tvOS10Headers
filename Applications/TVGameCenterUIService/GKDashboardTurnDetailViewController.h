...
- (void)handleTurnBasedEvent:(id)arg1;	// IMP=0x0000000100017930
- (void)turnOK:(id)arg1;	// IMP=0x000000010001791c
- (void)removeMatch:(id)arg1;	// IMP=0x0000000100017810
- (void)quitMatch:(id)arg1;	// IMP=0x0000000100017608
- (void)disableButtons;	// IMP=0x00000001000175a8
- (void)chooseMatch:(id)arg1;	// IMP=0x0000000100017500
- (void)declineInvitation:(id)arg1;	// IMP=0x00000001000173f4
- (void)acceptInvitation:(id)arg1;	// IMP=0x0000000100017368
- (void)refreshPresenter;	// IMP=0x00000001000172fc
- (id)preferredFocusEnvironments;	// IMP=0x000000010001727c
- (id)playingWithString;	// IMP=0x0000000100016f24
- (void)viewDidLoad;	// IMP=0x0000000100016808
- (void)dealloc;	// IMP=0x0000000100016788
- (id)initWithTurnBasedMatch:(id)arg1;	// IMP=0x0000000100016640
