...
- (void)share:(id)arg1;	// IMP=0x000000010000d0d0
- (void)challenge:(id)arg1;	// IMP=0x000000010000cfcc
- (void)configureForAchievements;	// IMP=0x000000010000c72c
- (id)preferredFocusEnvironments;	// IMP=0x000000010000c6ac
- (void)viewDidLoad;	// IMP=0x000000010000c640
- (void)dealloc;	// IMP=0x000000010000c5cc
- (id)initWithAchievement:(id)arg1 localAchievement:(id)arg2;	// IMP=0x000000010000c4ec
