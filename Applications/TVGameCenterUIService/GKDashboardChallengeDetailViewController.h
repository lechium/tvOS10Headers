...
- (void)decline:(id)arg1;	// IMP=0x000000010001d500
- (void)challengeOK:(id)arg1;	// IMP=0x000000010001d4ec
- (void)play:(id)arg1;	// IMP=0x000000010001d494
- (void)updateLeaderboardImage;	// IMP=0x000000010001d444
- (void)configureForChallenge;	// IMP=0x000000010001d018
- (id)preferredFocusEnvironments;	// IMP=0x000000010001cf98
- (void)viewDidLoad;	// IMP=0x000000010001cebc
- (void)dealloc;	// IMP=0x000000010001ce60
- (id)initWithChallenge:(id)arg1;	// IMP=0x000000010001cd98
